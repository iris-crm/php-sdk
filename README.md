...
*SubscriptionsApi* | [**subscriptionsSampleTurboappApprovedGet**](docs/Api/SubscriptionsApi.md#subscriptionssampleturboappapprovedget) | **GET** /subscriptions/sample/turboapp.approved | Recieve a notification when a TurboApp is approved by a processor.
*SubscriptionsApi* | [**subscriptionsSampleTurboappRejectedGet**](docs/Api/SubscriptionsApi.md#subscriptionssampleturboapprejectedget) | **GET** /subscriptions/sample/turboapp.rejected | Recieve a notification when a TurboApp is declined by a processor.
...
*SubscriptionsApi* | [**subscriptionsSampleTurboappUpdatedGet**](docs/Api/SubscriptionsApi.md#subscriptionssampleturboappupdatedget) | **GET** /subscriptions/sample/turboapp.updated | Recieve a notification when a TurboApp receives an update from a processor.
