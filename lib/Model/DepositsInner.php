...
/**
 * DepositsInner Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class DepositsInner implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Deposits_inner';
...
'batch' => 'getBatch'    ];
     ...
     * Sets date
     *
     * @param \DateTime $date Deposit date
     *
     * @return $this
     */
     ...
     * Sets transactions
     *
     * @param int $transactions Transactions count
     *
     * @return $this
     */
     ...
     * Sets batch
     *
     * @param string $batch Deposit batch number
     *
     * @return $this
     */
