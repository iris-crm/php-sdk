...
const EVENTS_TURBOAPPSUBMITTED = 'turboapp.submitted';
const EVENTS_TURBOAPPUPDATED = 'turboapp.updated';
const EVENTS_TURBOAPPAPPROVED = 'turboapp.approved';
const EVENTS_TURBOAPPDECLINED = 'turboapp.declined';
const EVENTS_RESIDUALSREPORTPUBLISHED = 'residuals.report.published';
const EVENTS_RESIDUALSLINEITEMADDED = 'residuals.lineitem.added';
...
self::EVENTS_TURBOAPPSUBMITTED,
self::EVENTS_TURBOAPPUPDATED,
self::EVENTS_TURBOAPPAPPROVED,
self::EVENTS_TURBOAPPDECLINED,
self::EVENTS_RESIDUALSREPORTPUBLISHED,
self::EVENTS_RESIDUALSLINEITEMADDED,
