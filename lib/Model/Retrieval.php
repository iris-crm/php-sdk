 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class Retrieval implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Retrieval';
...
'card_number' => 'card_number'    ];
    ...
    protected static $setters = [
        'retrieval_date' => 'setRetrievalDate',
...
'card_number' => 'setCardNumber'    ];
    ...
    protected static $getters = [
        'retrieval_date' => 'getRetrievalDate',
...
'card_number' => 'getCardNumber'    ];
    ...
    {
        $this->container['retrieval_date'] = isset($data['retrieval_date']) ? $data['retrieval_date'] : null;
    ...
    {
        return $this->container['retrieval_date'];
    }

    /**
     * Sets retrieval_date
     *
     * @param \DateTime $retrieval_date Retrieval date
     *
     * @return $this
     */
    public function setRetrievalDate($retrieval_date)
    {
        $this->container['retrieval_date'] = $retrieval_date;
     ...
     * Sets reason
     *
     * @param string $reason Retrieval reason
     *
     * @return $this
     */
