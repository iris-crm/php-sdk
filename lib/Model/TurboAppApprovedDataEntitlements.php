<?php
/**
 * TurboAppApprovedDataEntitlements
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * TurboAppApprovedDataEntitlements Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class TurboAppApprovedDataEntitlements implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'TurboAppApproved_data_entitlements';
...
'proc_flag' => 'getProcFlag'    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['srv'] = isset($data['srv']) ? $data['srv'] : null;
        $this->container['proc_flag'] = isset($data['proc_flag']) ? $data['proc_flag'] : null;
    }
    ...
    {
        return $this->container['srv'];
    }

    /**
     * Sets srv
     *
     * @param string $srv srv
     *
     * @return $this
     */
    public function setSrv($srv)
    {
        $this->container['srv'] = $srv;
     ...
     * @return string
     */
    public function getProcFlag()
    {
        return $this->container['proc_flag'];
    }

    /**
     * Sets proc_flag
     *
     * @param string $proc_flag proc_flag
     *
     * @return $this
     */
    public function setProcFlag($proc_flag)
    {
        $this->container['proc_flag'] = $proc_flag;
