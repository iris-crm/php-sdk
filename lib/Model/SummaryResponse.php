...
'merchants_count' => 'setMerchantsCount',
'sum_transactions' => 'setSumTransactions',
'sum_sales_amount' => 'setSumSalesAmount',
'sum_income' => 'setSumIncome',
'sum_expense' => 'setSumExpense',
'sum_net' => 'setSumNet',
'sum_bps' => 'setSumBps',
...
'merchants_count' => 'getMerchantsCount',
'sum_transactions' => 'getSumTransactions',
'sum_sales_amount' => 'getSumSalesAmount',
...
'sum_agent_net' => 'getSumAgentNet'    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['merchants_count'] = isset($data['merchants_count']) ? $data['merchants_count'] : null;
        $this->container['sum_transactions'] = isset($data['sum_transactions']) ? $data['sum_transactions'] : null;
        $this->container['sum_sales_amount'] = isset($data['sum_sales_amount']) ? $data['sum_sales_amount'] : null;
        $this->container['sum_income'] = isset($data['sum_income']) ? $data['sum_income'] : null;
        $this->container['sum_expense'] = isset($data['sum_expense']) ? $data['sum_expense'] : null;
        $this->container['sum_net'] = isset($data['sum_net']) ? $data['sum_net'] : null;
        $this->container['sum_bps'] = isset($data['sum_bps']) ? $data['sum_bps'] : null;
    ...
    /**
     * Gets merchants_count
     *
     * @return int
     */
    public function getMerchantsCount()
    {
        return $this->container['merchants_count'];
    }

    /**
     * Sets merchants_count
     *
     * @param int $merchants_count merchants_count
     *
     * @return $this
     */
    public function setMerchantsCount($merchants_count)
    {
        $this->container['merchants_count'] = $merchants_count;
    ...
    /**
     * Gets sum_sales_amount
     *
     * @return float
     */
    public function getSumSalesAmount()
    {
        return $this->container['sum_sales_amount'];
    }

    /**
     * Sets sum_sales_amount
     *
     * @param float $sum_sales_amount sum_sales_amount
     *
     * @return $this
     */
    public function setSumSalesAmount($sum_sales_amount)
    {
        $this->container['sum_sales_amount'] = $sum_sales_amount;
    ...
    {
        return $this->container['sum_expense'];
    }

    /**
     * Sets sum_expense
     *
     * @param float $sum_expense sum_expense
     *
     * @return $this
     */
    public function setSumExpense($sum_expense)
    {
        $this->container['sum_expense'] = $sum_expense;
     ...
     * @return float
     */
    public function getSumBps()
    {
        return $this->container['sum_bps'];
    }

    /**
     * Sets sum_bps
     *
     * @param float $sum_bps sum_bps
     *
     * @return $this
     */
    public function setSumBps($sum_bps)
    {
        $this->container['sum_bps'] = $sum_bps;
