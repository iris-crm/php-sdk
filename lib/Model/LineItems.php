...
'type' => 'string',
'item_id' => 'int',
'user' => '\Swagger\Client\Model\LineItemsUser',
'merchant' => '\Swagger\Client\Model\LineItemsMerchant',
'related_mid' => 'int',
'related_dba' => 'string',
'description' => 'string',
'income' => 'int',
...
'created' => '\DateTime',
'modified' => '\DateTime',
'agents' => '\Swagger\Client\Model\LineItemsAgents[]',
'recurring_start_date' => '\DateTime',
'recurring_payment_count' => 'int',
'recurring_max_payment_count' => 'int',
...
'recurring_payment_count' => null,
'recurring_max_payment_count' => null,
...
'recurring_max_payment_count' => 'recurring_max_payment_count',
...
'related_mid' => 'setRelatedMid',
'related_dba' => 'setRelatedDba',
'description' => 'setDescription',
'income' => 'setIncome',
'expense' => 'setExpense',
'percentage' => 'setPercentage',
'agent_net' => 'setAgentNet',
'is_recurring' => 'setIsRecurring',
'created' => 'setCreated',
'modified' => 'setModified',
'agents' => 'setAgents',
'recurring_start_date' => 'setRecurringStartDate',
'recurring_payment_count' => 'setRecurringPaymentCount',
'recurring_max_payment_count' => 'setRecurringMaxPaymentCount',
...
'related_mid' => 'getRelatedMid',
'related_dba' => 'getRelatedDba',
'description' => 'getDescription',
'income' => 'getIncome',
'expense' => 'getExpense',
'percentage' => 'getPercentage',
'agent_net' => 'getAgentNet',
'is_recurring' => 'getIsRecurring',
'created' => 'getCreated',
'modified' => 'getModified',
'agents' => 'getAgents',
'recurring_start_date' => 'getRecurringStartDate',
'recurring_payment_count' => 'getRecurringPaymentCount',
'recurring_max_payment_count' => 'getRecurringMaxPaymentCount',
...
const RECURRING_PERIOD_WEEKLY = 'weekly';
const RECURRING_PERIOD_MONTHLY = 'monthly';
const RECURRING_PERIOD_QUARTERLY = 'quarterly';
const RECURRING_PERIOD_YEARLY = 'yearly';
...
self::TYPE_MERCHANT,        ];
     ...
     * @return string[]
     */
    public function getRecurringPeriodAllowableValues()
    {
        return [
            self::RECURRING_PERIOD_WEEKLY,
self::RECURRING_PERIOD_MONTHLY,
self::RECURRING_PERIOD_QUARTERLY,
self::RECURRING_PERIOD_YEARLY,        ];
    }
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['related_mid'] = isset($data['related_mid']) ? $data['related_mid'] : null;
        $this->container['related_dba'] = isset($data['related_dba']) ? $data['related_dba'] : null;
        ...
        $this->container['agent_net'] = isset($data['agent_net']) ? $data['agent_net'] : null;
        ...
        $this->container['recurring_payment_count'] = isset($data['recurring_payment_count']) ? $data['recurring_payment_count'] : null;
        $this->container['recurring_max_payment_count'] = isset($data['recurring_max_payment_count']) ? $data['recurring_max_payment_count'] : null;
        $this->container['recurring_period'] = isset($data['recurring_period']) ? $data['recurring_period'] : null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        $allowedValues = $this->getRecurringPeriodAllowableValues();
        if (!is_null($this->container['recurring_period']) && !in_array($this->container['recurring_period'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value for 'recurring_period', must be one of '%s'",
                implode("', '", $allowedValues)
            );
        }
     ...
     * Gets user
     *
     * @return \Swagger\Client\Model\LineItemsUser
     */
     ...
     * Sets user
     *
     * @param \Swagger\Client\Model\LineItemsUser $user user
     *
     * @return $this
     */
     ...
     * Gets merchant
     *
     * @return \Swagger\Client\Model\LineItemsMerchant
     */
     ...
     * Sets merchant
     *
     * @param \Swagger\Client\Model\LineItemsMerchant $merchant merchant
     *
     * @return $this
     */
     ...
     * @return int
     */
    public function getRelatedMid()
    {
        return $this->container['related_mid'];
    }

    /**
     * Sets related_mid
     *
     * @param int $related_mid related_mid
     *
     * @return $this
     */
    public function setRelatedMid($related_mid)
    {
        $this->container['related_mid'] = $related_mid;
     ...
     * @return string
     */
    public function getRelatedDba()
    {
        return $this->container['related_dba'];
    }

    /**
     * Sets related_dba
     *
     * @param string $related_dba related_dba
     *
     * @return $this
     */
    public function setRelatedDba($related_dba)
    {
        $this->container['related_dba'] = $related_dba;
     ...
     * @return int
     */
    public function getAgentNet()
    {
        return $this->container['agent_net'];
    }

    /**
     * Sets agent_net
     *
     * @param int $agent_net agent_net
     *
     * @return $this
     */
    public function setAgentNet($agent_net)
    {
        $this->container['agent_net'] = $agent_net;
     ...
     * Sets created
     *
     * @param \DateTime $created Created date of line item
     *
     * @return $this
     */
     ...
     * Sets modified
     *
     * @param \DateTime $modified Last update date of line item
     *
     * @return $this
     */
     ...
     * Gets agents
     *
     * @return \Swagger\Client\Model\LineItemsAgents[]
     */
     ...
     * Sets agents
     *
     * @param \Swagger\Client\Model\LineItemsAgents[] $agents agents
     *
     * @return $this
     */
     ...
     *
     * @param \DateTime $recurring_start_date Date of start recurring line item
     *
     * @return $this
     */
    ...
    /**
     * Gets recurring_payment_count
     *
     * @return int
     */
    public function getRecurringPaymentCount()
    {
        return $this->container['recurring_payment_count'];
    }

    /**
     * Sets recurring_payment_count
     *
     * @param int $recurring_payment_count Count of payments what was already done
     *
     * @return $this
     */
    public function setRecurringPaymentCount($recurring_payment_count)
    {
        $this->container['recurring_payment_count'] = $recurring_payment_count;

        return $this;
    }

    /**
     * Gets recurring_max_payment_count
     *
     * @return int
     */
    public function getRecurringMaxPaymentCount()
    {
        return $this->container['recurring_max_payment_count'];
    }

    /**
     * Sets recurring_max_payment_count
     *
     * @param int $recurring_max_payment_count Count of payments which will be done (this will be null if there is no limit)
     *
     * @return $this
     */
    public function setRecurringMaxPaymentCount($recurring_max_payment_count)
    {
        $this->container['recurring_max_payment_count'] = $recurring_max_payment_count;
     ...
     *
     * @param string $recurring_period recurring_period
     *
     * @return $this
     */
    ...
    {
        $allowedValues = $this->getRecurringPeriodAllowableValues();
        if (!is_null($recurring_period) && !in_array($recurring_period, $allowedValues, true)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value for 'recurring_period', must be one of '%s'",
                    implode("', '", $allowedValues)
