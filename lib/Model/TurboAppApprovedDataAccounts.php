...
'approve_at' => 'getApproveAt'    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['approve_at'] = isset($data['approve_at']) ? $data['approve_at'] : null;
    }
    ...
    {
        return $this->container['approve_at'];
    }

    /**
     * Sets approve_at
     *
     * @param \DateTime $approve_at Date and time of account approve (ISO 8601)
     *
     * @return $this
     */
    public function setApproveAt($approve_at)
    {
        $this->container['approve_at'] = $approve_at;
