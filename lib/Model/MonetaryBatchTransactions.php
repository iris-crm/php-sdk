...
/**
 * MonetaryBatchTransactions Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class MonetaryBatchTransactions implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'MonetaryBatch_transactions';
...
'invoice_number' => 'getInvoiceNumber'    ];
     ...
     * Sets cardholder
     *
     * @param string $cardholder Cardholder number
     *
     * @return $this
     */
     ...
     * Sets auth_code
     *
     * @param string $auth_code Transaction auth code
     *
     * @return $this
     */
     ...
     * Sets pos_entry_mode
     *
     * @param string $pos_entry_mode POS entry mode
     *
     * @return $this
     */
