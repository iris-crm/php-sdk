...
/**
 * ResidualsApi Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
...
class ResidualsApi
{
    ...
    /**
     * Operation residualsLineitemsYearMonthGet
     *
     * Get residuals line items
     *
     * @param  int $year Line Item year (required)
     * @param  int $month Line Item month (required)
     * @param  \DateTime $created Filter line items by a date (Y-m-d) (optional)
     * @param  string $dba dba (optional)
     ...
     */
    public function residualsLineitemsYearMonthGet($year, $month, $created = null, $dba = null, $username = null, $user_id = null, $description = null, $page = null, $per_page = null)
    {
        list($response) = $this->residualsLineitemsYearMonthGetWithHttpInfo($year, $month, $created, $dba, $username, $user_id, $description, $page, $per_page);
        return $response;
    }

    /**
     * Operation residualsLineitemsYearMonthGetWithHttpInfo
     *
     * Get residuals line items
     *
     * @param  int $year Line Item year (required)
     ...
     */
    public function residualsLineitemsYearMonthGetWithHttpInfo($year, $month, $created = null, $dba = null, $username = null, $user_id = null, $description = null, $page = null, $per_page = null)
    {
        $returnType = '\Swagger\Client\Model\InlineResponse20011';
        $request = $this->residualsLineitemsYearMonthGetRequest($year, $month, $created, $dba, $username, $user_id, $description, $page, $per_page);
    ...
    /**
     * Operation residualsLineitemsYearMonthGetAsync
     *
     * Get residuals line items
     *
     * @param  int $year Line Item year (required)
     ...
     */
    public function residualsLineitemsYearMonthGetAsync($year, $month, $created = null, $dba = null, $username = null, $user_id = null, $description = null, $page = null, $per_page = null)
    {
        return $this->residualsLineitemsYearMonthGetAsyncWithHttpInfo($year, $month, $created, $dba, $username, $user_id, $description, $page, $per_page)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation residualsLineitemsYearMonthGetAsyncWithHttpInfo
     *
     * Get residuals line items
     *
     * @param  int $year Line Item year (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function residualsLineitemsYearMonthGetAsyncWithHttpInfo($year, $month, $created = null, $dba = null, $username = null, $user_id = null, $description = null, $page = null, $per_page = null)
    {
        $returnType = '\Swagger\Client\Model\InlineResponse20011';
        $request = $this->residualsLineitemsYearMonthGetRequest($year, $month, $created, $dba, $username, $user_id, $description, $page, $per_page);
    ...
    /**
     * Create request for operation 'residualsLineitemsYearMonthGet'
     *
     * @param  int $year Line Item year (required)
     * @param  int $month Line Item month (required)
     * @param  \DateTime $created Filter line items by a date (Y-m-d) (optional)
     ...
     */
    protected function residualsLineitemsYearMonthGetRequest($year, $month, $created = null, $dba = null, $username = null, $user_id = null, $description = null, $page = null, $per_page = null)
    {
        // verify the required parameter 'year' is set
        if ($year === null || (is_array($year) && count($year) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $year when calling residualsLineitemsYearMonthGet'
            );
        }
        // verify the required parameter 'month' is set
        if ($month === null || (is_array($month) && count($month) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $month when calling residualsLineitemsYearMonthGet'
            );
        }

        $resourcePath = '/residuals/lineitems/{year}/{month}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // query params
        if ($created !== null) {
            $queryParams['created'] = ObjectSerializer::toQueryValue($created, 'date');
        }
        // query params
        if ($dba !== null) {
            $queryParams['dba'] = ObjectSerializer::toQueryValue($dba, null);
        }
        // query params
        if ($username !== null) {
    ...
    /**
     * Operation residualsReportsDetailsProcessorIdYearMonthGet
     *
     * Get residuals details with merchant rows
     *
     * @param  int $processor_id Processor ID (required)
     * @param  int $year Residuals year (required)
     * @param  int $month Residuals month (required)
     * @param  int $group Get residuals summary only for specific group (optional)
     * @param  int $agent Get residuals summary only for specific user agent (optional)
     * @param  string $search Search query (optional)
     * @param  bool $hide_null_merchants Flag for hiding inactive merchants (true by default) (optional)
     * @param  int $page Page number (optional)
     * @param  int $per_page Count of records per page (optional)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     ...
     */
    public function residualsReportsDetailsProcessorIdYearMonthGet($processor_id, $year, $month, $group = null, $agent = null, $search = null, $hide_null_merchants = null, $page = null, $per_page = null)
    {
        list($response) = $this->residualsReportsDetailsProcessorIdYearMonthGetWithHttpInfo($processor_id, $year, $month, $group, $agent, $search, $hide_null_merchants, $page, $per_page);
        return $response;
    }

    /**
     * Operation residualsReportsDetailsProcessorIdYearMonthGetWithHttpInfo
     *
     * Get residuals details with merchant rows
     *
     * @param  int $processor_id Processor ID (required)
     ...
     */
    public function residualsReportsDetailsProcessorIdYearMonthGetWithHttpInfo($processor_id, $year, $month, $group = null, $agent = null, $search = null, $hide_null_merchants = null, $page = null, $per_page = null)
    {
        $returnType = '\Swagger\Client\Model\InlineResponse20010';
        $request = $this->residualsReportsDetailsProcessorIdYearMonthGetRequest($processor_id, $year, $month, $group, $agent, $search, $hide_null_merchants, $page, $per_page);
    ...
    /**
     * Operation residualsReportsDetailsProcessorIdYearMonthGetAsync
     *
     * Get residuals details with merchant rows
     *
     * @param  int $processor_id Processor ID (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function residualsReportsDetailsProcessorIdYearMonthGetAsync($processor_id, $year, $month, $group = null, $agent = null, $search = null, $hide_null_merchants = null, $page = null, $per_page = null)
    {
        return $this->residualsReportsDetailsProcessorIdYearMonthGetAsyncWithHttpInfo($processor_id, $year, $month, $group, $agent, $search, $hide_null_merchants, $page, $per_page)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation residualsReportsDetailsProcessorIdYearMonthGetAsyncWithHttpInfo
     *
     * Get residuals details with merchant rows
     *
     * @param  int $processor_id Processor ID (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function residualsReportsDetailsProcessorIdYearMonthGetAsyncWithHttpInfo($processor_id, $year, $month, $group = null, $agent = null, $search = null, $hide_null_merchants = null, $page = null, $per_page = null)
    {
        $returnType = '\Swagger\Client\Model\InlineResponse20010';
        $request = $this->residualsReportsDetailsProcessorIdYearMonthGetRequest($processor_id, $year, $month, $group, $agent, $search, $hide_null_merchants, $page, $per_page);
    ...
    /**
     * Create request for operation 'residualsReportsDetailsProcessorIdYearMonthGet'
     *
     * @param  int $processor_id Processor ID (required)
     * @param  int $year Residuals year (required)
     * @param  int $month Residuals month (required)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function residualsReportsDetailsProcessorIdYearMonthGetRequest($processor_id, $year, $month, $group = null, $agent = null, $search = null, $hide_null_merchants = null, $page = null, $per_page = null)
    {
        // verify the required parameter 'processor_id' is set
        if ($processor_id === null || (is_array($processor_id) && count($processor_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $processor_id when calling residualsReportsDetailsProcessorIdYearMonthGet'
            );
        }
        // verify the required parameter 'year' is set
        if ($year === null || (is_array($year) && count($year) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $year when calling residualsReportsDetailsProcessorIdYearMonthGet'
            );
        }
        // verify the required parameter 'month' is set
        if ($month === null || (is_array($month) && count($month) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $month when calling residualsReportsDetailsProcessorIdYearMonthGet'
            );
        }

        $resourcePath = '/residuals/reports/details/{processor_id}/{year}/{month}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // query params
        if ($agent !== null) {
            $queryParams['agent'] = ObjectSerializer::toQueryValue($agent, null);
        }
        // query params
        if ($search !== null) {
        ...
        // query params
        if ($hide_null_merchants !== null) {
            $queryParams['hide_null_merchants'] = ObjectSerializer::toQueryValue($hide_null_merchants, null);
        }
        // query params
        if ($page !== null) {
            $queryParams['page'] = ObjectSerializer::toQueryValue($page, null);
        ...
        if ($processor_id !== null) {
            $resourcePath = str_replace(
                '{' . 'processor_id' . '}',
                ObjectSerializer::toPathValue($processor_id),
                $resourcePath
            );
        }
        // path params
    ...
    /**
     * Operation residualsReportsSummaryRowsProcessorIdYearMonthGet
     *
     ...
     * @param  string $search Search query (optional)
     * @param  bool $hide_null_merchants Flag for hiding inactive merchants (true by default) (optional)
     * @param  bool $template Flag for applying user templates (true by default) (optional)
     * @param  int $page Page number (optional)
     * @param  int $per_page Count of records per page (optional)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     ...
     */
    public function residualsReportsSummaryRowsProcessorIdYearMonthGet($processor_id, $year, $month, $group = null, $agent = null, $search = null, $hide_null_merchants = null, $template = null, $page = null, $per_page = null)
    {
        list($response) = $this->residualsReportsSummaryRowsProcessorIdYearMonthGetWithHttpInfo($processor_id, $year, $month, $group, $agent, $search, $hide_null_merchants, $template, $page, $per_page);
        return $response;
    }

    /**
     * Operation residualsReportsSummaryRowsProcessorIdYearMonthGetWithHttpInfo
     *
     * Get residuals summary with merchant rows
     *
     * @param  int $processor_id Processor ID (required)
     ...
     */
    public function residualsReportsSummaryRowsProcessorIdYearMonthGetWithHttpInfo($processor_id, $year, $month, $group = null, $agent = null, $search = null, $hide_null_merchants = null, $template = null, $page = null, $per_page = null)
    {
        $returnType = '\Swagger\Client\Model\InlineResponse2009';
        $request = $this->residualsReportsSummaryRowsProcessorIdYearMonthGetRequest($processor_id, $year, $month, $group, $agent, $search, $hide_null_merchants, $template, $page, $per_page);
    ...
    /**
     * Operation residualsReportsSummaryRowsProcessorIdYearMonthGetAsync
     *
     * Get residuals summary with merchant rows
     *
     * @param  int $processor_id Processor ID (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function residualsReportsSummaryRowsProcessorIdYearMonthGetAsync($processor_id, $year, $month, $group = null, $agent = null, $search = null, $hide_null_merchants = null, $template = null, $page = null, $per_page = null)
    {
        return $this->residualsReportsSummaryRowsProcessorIdYearMonthGetAsyncWithHttpInfo($processor_id, $year, $month, $group, $agent, $search, $hide_null_merchants, $template, $page, $per_page)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation residualsReportsSummaryRowsProcessorIdYearMonthGetAsyncWithHttpInfo
     *
     * Get residuals summary with merchant rows
     *
     * @param  int $processor_id Processor ID (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function residualsReportsSummaryRowsProcessorIdYearMonthGetAsyncWithHttpInfo($processor_id, $year, $month, $group = null, $agent = null, $search = null, $hide_null_merchants = null, $template = null, $page = null, $per_page = null)
    {
        $returnType = '\Swagger\Client\Model\InlineResponse2009';
        $request = $this->residualsReportsSummaryRowsProcessorIdYearMonthGetRequest($processor_id, $year, $month, $group, $agent, $search, $hide_null_merchants, $template, $page, $per_page);
    ...
    /**
     * Create request for operation 'residualsReportsSummaryRowsProcessorIdYearMonthGet'
     *
     * @param  int $processor_id Processor ID (required)
     * @param  int $year Residuals year (required)
     * @param  int $month Residuals month (required)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function residualsReportsSummaryRowsProcessorIdYearMonthGetRequest($processor_id, $year, $month, $group = null, $agent = null, $search = null, $hide_null_merchants = null, $template = null, $page = null, $per_page = null)
    {
        // verify the required parameter 'processor_id' is set
        if ($processor_id === null || (is_array($processor_id) && count($processor_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $processor_id when calling residualsReportsSummaryRowsProcessorIdYearMonthGet'
            );
        }
        // verify the required parameter 'year' is set
        if ($year === null || (is_array($year) && count($year) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $year when calling residualsReportsSummaryRowsProcessorIdYearMonthGet'
            );
        }
        // verify the required parameter 'month' is set
        if ($month === null || (is_array($month) && count($month) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $month when calling residualsReportsSummaryRowsProcessorIdYearMonthGet'
            );
        }

        $resourcePath = '/residuals/reports/summary/rows/{processor_id}/{year}/{month}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation residualsReportsSummaryYearMonthGet
     *
     * Get residuals summary data
     *
     * @param  int $year Residuals year (required)
     * @param  int $month Residuals month (required)
     * @param  int $processor Get residuals summary only for specific processor (optional)
     * @param  int $group Get residuals summary only for specific group (optional)
     * @param  int $agent Get residuals summary only for specific user agent (optional)
     * @param  string $search Search query (optional)
     * @param  bool $hide_null_merchants Flag for hiding inactive merchants (true by default) (optional)
     ...
     */
    public function residualsReportsSummaryYearMonthGet($year, $month, $processor = null, $group = null, $agent = null, $search = null, $hide_null_merchants = null, $page = null, $per_page = null)
    {
        list($response) = $this->residualsReportsSummaryYearMonthGetWithHttpInfo($year, $month, $processor, $group, $agent, $search, $hide_null_merchants, $page, $per_page);
        return $response;
    }

    /**
     * Operation residualsReportsSummaryYearMonthGetWithHttpInfo
     *
     * Get residuals summary data
     *
     * @param  int $year Residuals year (required)
     ...
     */
    public function residualsReportsSummaryYearMonthGetWithHttpInfo($year, $month, $processor = null, $group = null, $agent = null, $search = null, $hide_null_merchants = null, $page = null, $per_page = null)
    {
        $returnType = '\Swagger\Client\Model\InlineResponse2008';
        $request = $this->residualsReportsSummaryYearMonthGetRequest($year, $month, $processor, $group, $agent, $search, $hide_null_merchants, $page, $per_page);
    ...
    /**
     * Operation residualsReportsSummaryYearMonthGetAsync
     *
     * Get residuals summary data
     *
     * @param  int $year Residuals year (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function residualsReportsSummaryYearMonthGetAsync($year, $month, $processor = null, $group = null, $agent = null, $search = null, $hide_null_merchants = null, $page = null, $per_page = null)
    {
        return $this->residualsReportsSummaryYearMonthGetAsyncWithHttpInfo($year, $month, $processor, $group, $agent, $search, $hide_null_merchants, $page, $per_page)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation residualsReportsSummaryYearMonthGetAsyncWithHttpInfo
     *
     * Get residuals summary data
     *
     * @param  int $year Residuals year (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function residualsReportsSummaryYearMonthGetAsyncWithHttpInfo($year, $month, $processor = null, $group = null, $agent = null, $search = null, $hide_null_merchants = null, $page = null, $per_page = null)
    {
        $returnType = '\Swagger\Client\Model\InlineResponse2008';
        $request = $this->residualsReportsSummaryYearMonthGetRequest($year, $month, $processor, $group, $agent, $search, $hide_null_merchants, $page, $per_page);
    ...
    /**
     * Create request for operation 'residualsReportsSummaryYearMonthGet'
     *
     * @param  int $year Residuals year (required)
     * @param  int $month Residuals month (required)
     * @param  int $processor Get residuals summary only for specific processor (optional)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function residualsReportsSummaryYearMonthGetRequest($year, $month, $processor = null, $group = null, $agent = null, $search = null, $hide_null_merchants = null, $page = null, $per_page = null)
    {
        // verify the required parameter 'year' is set
        if ($year === null || (is_array($year) && count($year) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $year when calling residualsReportsSummaryYearMonthGet'
            );
        }
        // verify the required parameter 'month' is set
        if ($month === null || (is_array($month) && count($month) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $month when calling residualsReportsSummaryYearMonthGet'
            );
        }

        $resourcePath = '/residuals/reports/summary/{year}/{month}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation residualsTemplatesAssignedYearMonthGet
     *
     * Get a list of users with assigned residuals templates
     *
     * @param  int $year Residuals year (required)
     * @param  int $month Residuals month (required)
     * @param  int $user Filter templates by user (optional)
     * @param  int $processor Filter templates by processor (optional)
     * @param  int $group Filter templates by group (optional)
     * @param  int $class Filter templates by user class (optional)
     * @param  int $page Page number (optional)
     * @param  int $per_page Count of records per page (optional)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     ...
     */
    public function residualsTemplatesAssignedYearMonthGet($year, $month, $user = null, $processor = null, $group = null, $class = null, $page = null, $per_page = null)
    {
        list($response) = $this->residualsTemplatesAssignedYearMonthGetWithHttpInfo($year, $month, $user, $processor, $group, $class, $page, $per_page);
        return $response;
    }

    /**
     * Operation residualsTemplatesAssignedYearMonthGetWithHttpInfo
     *
     * Get a list of users with assigned residuals templates
     *
     * @param  int $year Residuals year (required)
     ...
     */
    public function residualsTemplatesAssignedYearMonthGetWithHttpInfo($year, $month, $user = null, $processor = null, $group = null, $class = null, $page = null, $per_page = null)
    {
        $returnType = '\Swagger\Client\Model\InlineResponse20013';
        $request = $this->residualsTemplatesAssignedYearMonthGetRequest($year, $month, $user, $processor, $group, $class, $page, $per_page);
    ...
    /**
     * Operation residualsTemplatesAssignedYearMonthGetAsync
     *
     * Get a list of users with assigned residuals templates
     *
     * @param  int $year Residuals year (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function residualsTemplatesAssignedYearMonthGetAsync($year, $month, $user = null, $processor = null, $group = null, $class = null, $page = null, $per_page = null)
    {
        return $this->residualsTemplatesAssignedYearMonthGetAsyncWithHttpInfo($year, $month, $user, $processor, $group, $class, $page, $per_page)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation residualsTemplatesAssignedYearMonthGetAsyncWithHttpInfo
     *
     * Get a list of users with assigned residuals templates
     *
     * @param  int $year Residuals year (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function residualsTemplatesAssignedYearMonthGetAsyncWithHttpInfo($year, $month, $user = null, $processor = null, $group = null, $class = null, $page = null, $per_page = null)
    {
        $returnType = '\Swagger\Client\Model\InlineResponse20013';
        $request = $this->residualsTemplatesAssignedYearMonthGetRequest($year, $month, $user, $processor, $group, $class, $page, $per_page);
    ...
    /**
     * Create request for operation 'residualsTemplatesAssignedYearMonthGet'
     *
     * @param  int $year Residuals year (required)
     * @param  int $month Residuals month (required)
     * @param  int $user Filter templates by user (optional)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function residualsTemplatesAssignedYearMonthGetRequest($year, $month, $user = null, $processor = null, $group = null, $class = null, $page = null, $per_page = null)
    {
        // verify the required parameter 'year' is set
        if ($year === null || (is_array($year) && count($year) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $year when calling residualsTemplatesAssignedYearMonthGet'
            );
        }
        // verify the required parameter 'month' is set
        if ($month === null || (is_array($month) && count($month) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $month when calling residualsTemplatesAssignedYearMonthGet'
            );
        }

        $resourcePath = '/residuals/templates/assigned/{year}/{month}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation residualsTemplatesGet
     *
     * Get residuals templates
     *
     * @param  string $name Filter templates by name (optional)
     * @param  string $revision Filter templates by revision (optional)
     * @param  int $creator Filter templates by creator (optional)
     * @param  int $page Page number (optional)
     * @param  int $per_page Count of records per page (optional)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     ...
     */
    public function residualsTemplatesGet($name = null, $revision = null, $creator = null, $page = null, $per_page = null)
    {
        list($response) = $this->residualsTemplatesGetWithHttpInfo($name, $revision, $creator, $page, $per_page);
        return $response;
    }

    /**
     * Operation residualsTemplatesGetWithHttpInfo
     *
     * Get residuals templates
     *
     * @param  string $name Filter templates by name (optional)
     ...
     */
    public function residualsTemplatesGetWithHttpInfo($name = null, $revision = null, $creator = null, $page = null, $per_page = null)
    {
        $returnType = '\Swagger\Client\Model\InlineResponse20012';
        $request = $this->residualsTemplatesGetRequest($name, $revision, $creator, $page, $per_page);
    ...
    /**
     * Operation residualsTemplatesGetAsync
     *
     * Get residuals templates
     *
     * @param  string $name Filter templates by name (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function residualsTemplatesGetAsync($name = null, $revision = null, $creator = null, $page = null, $per_page = null)
    {
        return $this->residualsTemplatesGetAsyncWithHttpInfo($name, $revision, $creator, $page, $per_page)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation residualsTemplatesGetAsyncWithHttpInfo
     *
     * Get residuals templates
     *
     * @param  string $name Filter templates by name (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function residualsTemplatesGetAsyncWithHttpInfo($name = null, $revision = null, $creator = null, $page = null, $per_page = null)
    {
        $returnType = '\Swagger\Client\Model\InlineResponse20012';
        $request = $this->residualsTemplatesGetRequest($name, $revision, $creator, $page, $per_page);
    ...
    /**
     * Create request for operation 'residualsTemplatesGet'
     *
     * @param  string $name Filter templates by name (optional)
     * @param  string $revision Filter templates by revision (optional)
     * @param  int $creator Filter templates by creator (optional)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function residualsTemplatesGetRequest($name = null, $revision = null, $creator = null, $page = null, $per_page = null)
    {

        $resourcePath = '/residuals/templates/';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // query params
        if ($revision !== null) {
            $queryParams['revision'] = ObjectSerializer::toQueryValue($revision, null);
        }
        // query params
        if ($creator !== null) {
