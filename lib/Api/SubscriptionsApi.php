...
class SubscriptionsApi
{
    ...
    /**
     * Operation subscriptionsSampleTurboappRejectedGet
     *
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Model\TurboAppRejected
     */
    public function subscriptionsSampleTurboappRejectedGet()
    {
        list($response) = $this->subscriptionsSampleTurboappRejectedGetWithHttpInfo();
        return $response;
    }

    /**
     * Operation subscriptionsSampleTurboappRejectedGetWithHttpInfo
     *
     * Recieve a notification when a TurboApp is declined by a processor.
     *
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\TurboAppRejected, HTTP status code, HTTP response headers (array of strings)
     */
    public function subscriptionsSampleTurboappRejectedGetWithHttpInfo()
    {
        $returnType = '\Swagger\Client\Model\TurboAppRejected';
        $request = $this->subscriptionsSampleTurboappRejectedGetRequest();
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Model\TurboAppRejected',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    /**
     * Operation subscriptionsSampleTurboappRejectedGetAsync
     *
     * Recieve a notification when a TurboApp is declined by a processor.
     *
     *
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function subscriptionsSampleTurboappRejectedGetAsync()
    {
        return $this->subscriptionsSampleTurboappRejectedGetAsyncWithHttpInfo()
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation subscriptionsSampleTurboappRejectedGetAsyncWithHttpInfo
     *
     * Recieve a notification when a TurboApp is declined by a processor.
     *
     *
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function subscriptionsSampleTurboappRejectedGetAsyncWithHttpInfo()
    {
        $returnType = '\Swagger\Client\Model\TurboAppRejected';
        $request = $this->subscriptionsSampleTurboappRejectedGetRequest();
    ...
    /**
     * Create request for operation 'subscriptionsSampleTurboappRejectedGet'
     *
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function subscriptionsSampleTurboappRejectedGetRequest()
    {

        $resourcePath = '/subscriptions/sample/turboapp.rejected';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
